		...
		<!--Header Wrapper ends-->
			...
			<div class="content">
				...
				<div id="content_timeline">
					<form action="output.php" method="post" id="f">
					<center><br><br><input type='submit' name='b2' value='Word Cloud'  ><br/> 
					<br><br><input type='submit' name='b3' value='Topic Models'  ><br/> </center>
					</form>
